...
#        url = requests.get("http://polines.educatics.org/pdf/api.php")
        url = requests.get("http://polines.educatics.org/public/api/parametros")
...
#        params = urllib.urlencode({'username' : 'manuelibarra', 'password' : '', 'message' : sms , 'msisdn' : 51927615565})
        params = urllib.urlencode({'username' : 'xxxxxxxxx', 'password' : 'xxxxxxx', 'message' : sms , 'msisdn' : celular})
