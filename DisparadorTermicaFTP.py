...
#basepath = "/htdocs/python/"
	basepath ='/public/img/fotos_termica/'
...
#improtamos las variables de tokentelgram.py para mejor manejo
#
#        ftphost="ftp.soft.pe"
...
## cerramos la conexion
        ftp.close()
	print "se enviaron las fotos termicas ftp"
	con.close()

except:

        print "nose envio ningun foto de la termica  al servidor "
